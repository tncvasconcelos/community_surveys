...
names(subset_bees)[names(subset_bees) == "bio1"] <- "temperature"
names(subset_bees)[names(subset_bees) == "bio4"] <- "temp_seasonality"
names(subset_bees)[names(subset_bees) == "bio12"] <- "precipitation"
names(subset_bees)[names(subset_bees) == "bio15"] <- "prec_seasonality"
